...
# from ..items import InfoDetailItem
#
#
# class SuppleInfo(scrapy.Spider):
#     name = 'supple_info'
...
#         spider = super(SuppleInfo, cls).from_crawler(
#             crawler, *args, **kwargs
#         )
...
#             cursor.execute("SELECT * FROM `company_data_source_complete20191010_copy` "
#                            "WHERE exchange_market_code='SSE' ORDER BY id ASC ;")
#             feild_list = cursor.fetchall()
#             conn.close()
#             return feild_list
#
#     def start_requests(self):
#         for feild_value in self.spider_opened():
#             self.data_form['productid'] = feild_value['security_code']
...
#                 meta={
#                     # 'proxy': 'http://58.218.200.225:5669'
#                     'company_code': feild_value['company_code']
#                 }
#             )
#
